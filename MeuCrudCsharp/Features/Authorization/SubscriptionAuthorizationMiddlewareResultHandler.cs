...
public class SubscriptionAuthorizationMiddlewareResultHandler : IAuthorizationMiddlewareResultHandler
{
        ...
        PolicyAuthorizationResult authorizeResult)
    {
        ...
        if (authorizeResult.Forbidden)
        {
            ...
            if (authorizeResult.AuthorizationFailure.FailedRequirements.Any(req => req is ActiveSubscriptionRequirement))
            {
                ...
                var isApiCall = context.Request.Headers["Accept"].ToString().Contains("application/json");
