...
public class MercadoPagoSubscriptionService : MercadoPagoServiceBase, IMercadoPagoSubscriptionService
{
    ...
    public async Task<SubscriptionResponseDto> CreateSubscriptionAsync(CreateSubscriptionDto payload)
    {
    ...
    public async Task CancelSubscriptionAsync(string subscriptionId)
    {
        ...
        await UpdateSubscriptionStatusAsync(subscriptionId, new UpdateSubscriptionStatusDto("cancelled"));
    }
}